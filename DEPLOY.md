...
1. **GitHub** builds a Docker image every time you push to `main`, and publishes it to GitHub Container Registry (GHCR) at `ghcr.io/paulgsr/rhinetv:latest`.
...
```
ghcr.io/paulgsr/rhinetv:latest
ghcr.io/paulgsr/rhinetv:sha-<short>
```
...
curl -O https://raw.githubusercontent.com/paulgsr/RhineTV/main/docker-compose.yml
# image is already set to `ghcr.io/paulgsr/rhinetv:latest`
docker compose up -d
```
...
```yaml
image: ghcr.io/paulgsr/rhinetv:sha-abc1234
```
